...
public class PricingCommands {
    ...
    @ShellMethod(key="attach price component to screening", value="Usage: <component name> <room name> <start time>")
    ...
    public String showPricing(String movie, String room, LocalDateTime startTime, String seats){
        return "";
    }
